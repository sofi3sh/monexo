...
class AccrueBonus extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject(__('Achievement', [], $notifiable->locale))
            ->line(trans('notifications.email.bonus_achievement', $this->data, $notifiable->locale));
    }
    ...
    public function toTelegram($notifiable)
    {
        ...
        return TelegramMessage::create()
            ...
            ->content(
                __('Achievement', [], $notifiable->locale) . "\n" .
                __('Hello', [], $notifiable->locale) . ", {$notifiable->name}" . "\n" .
                trans('notifications.email.bonus_achievement', $this->data, $notifiable->locale) . "\n" .
