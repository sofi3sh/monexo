...
return [
    ...
    */
    'js-lang' => [
        'current' => 'ru',
        'wordCountValidate' => [
            'count'     => 'Количество символов в поле',
            'must'      => 'должно быть',
            'equal'     => 'равно',
            'inrange'   => 'в диапазоне от',
            'to'        => 'до',
        ],
        'formRulesUse' => 'Данное поле должно быть заполнено',
        'emailValidation' => [
            'email'     => 'Некорректный email. Проверьте правильность данных.'
        ],
        'sameValidate' => [
            'notsame' => 'не совпадают'
        ],
        'dateValidate' => [
            'plus18' => 'Вам должно быть 18+ лет',
            'format' => 'Неправильный формат даты. Укажите свою дату рождения в формате dd.mm.yyyy'
        ],
        'fields' => [
            'name' => 'Имя',
            'surname' => 'Фамилия',
    ...
    'gt'                   => [
        ...
        'string_min'  => 'Количество символов в поле amount должно быть больше.',
    ...
    */
    'custom' => [
        ...
        'image' => [
            'common_error' => 'Ошибка загрузки изображения. Убедитесь, что изображение имеет разрешение не более 1024 x 1024 точек.',
        ]
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'email-in-use' => 'Нельзя установить данные значения',
    'phone_format' => 'Неверный немер телефона. Введите номер телефона в международном формате',
];
