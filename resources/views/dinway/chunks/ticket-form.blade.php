                ...
                <div>
                    <div>
                        <label>
                            ...
                            <input class="tickets-form__input" type="text" name="ticket_full_name">
                        </label>
                    ...
                    <div>
                        <label>
                            ...
                            <input class="tickets-form__input" type="text"  name="ticket_phone">
                        </label>
                        <div class="invalid-feedback" data-error="phone"></div>
                    </div>
                    <div>
                        <span class="tickets-form__text">@lang('ticket.front.message')</span>
                        <textarea class="tickets-form__textarea" name="ticket_question" rows="3" maxlength="4096"></textarea>
