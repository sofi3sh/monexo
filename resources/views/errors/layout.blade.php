...
<body class="bg-gradient-green p-0 m-0">
  ...
  <!-- Main content -->
  <div class="container mt-7 pt-8 pb-8 mb-3">
    <div class="row justify-content-center text-center">
       <div class="col-xl-5 col-lg-6 col-md-8 px-5">
          <h1 class="text-white">@yield('code', __('Oh no'))</h1>
          <p class="text-lead text-white">@yield('message')</p>
          <a href="/" class="btn bg-neutral text-primary">@lang('auth.header.back_to_the_main_page')</a>
       </div>
    </div>
  </div>
