                                ...
                                @foreach($marketingPlanGroups['packages']['Standard'] as $index => $marketingPlanGroup)
                                    ...
                                    @else
                                        @if($userMarketingPlanStandardActive)
                                            ...
                                            @else
                                                <button class="investment-btn btn btn-sm btn-primary {{ $btnClass }}" data-upgrade="true" data-amount="{{ $marketingPlanGroup->max_invest_sum - $userMarketingPlanStandardActive->marketingPlan->max_invest_sum }}" data-id="{{ $marketingPlanGroup->id }}" data-name="{{-- $marketingPlanGroup->name --}}SERVER 1" data-toggle="modal" data-target="#investmentModal">
                                                    @lang('website_home.package.upgrade')
                                                </button>
                                            @endif
                                        @else
                                            <button class="investment-btn btn btn-sm btn-primary {{ $btnClass }}" data-amount="{{ $marketingPlanGroup->min_invest_sum }}" data-id="{{ $marketingPlanGroup->id }}" data-name="{{-- $marketingPlanGroup->name --}}SERVER 1" data-toggle="modal" data-target="#investmentModal">
                            ...
                            <div class="col-auto">
                                <div class="card card-stats p-4">
                                    ...
                                    <div class="d-table ml-auto mr-auto pb-4 mt-2">
                                        <div class="d-table-row">
                                            <div class="d-table-cell pr-3 py-2 pl-3" style="width: 70%"><b>@lang('website_home.package.daily_income', ['percent' => ''])</b></div>
                                            <div class="d-table-cell py-1  pr-3" style="width: 30%; white-space:nowrap">0.5 - 2%</div>
                                        </div>
                                        <div class="d-table-row">
                                            <div class="d-table-cell pr-3 py-2 pl-3"><b>@lang('website_home.package.period', ['days'=> ''])</b></div>
                                    ...
                                    <form class="js-package js-package-{{ \App\Models\Home\MarketingPlan::GROUP_MINI }}">
                                        <div class="row justify-content-center">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-amount">@lang('website_home.package.sum'), $</label>
                                                    <input id="input-amount-range-2" class="form-control" type="number" name="amountInput" min="{{ $marketingPlanGroup->min_invest_sum }}" max="{{ $marketingPlanGroup->max_invest_sum }}" value="{{ $marketingPlanGroup->min_invest_sum }}" step="1" oninput="this.form.amountRange.value=this.value" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-row justify-content-center pb-4">
...
<div class="container-fluid">
                        ...
                        <tr>
                            ...
                            <td>
                                @if(isset($item->marketingPlan->name))
                                    ...
                                    @if(strpos($item->marketingPlan->name,'Mini') !== false) SERVER 3 @endif
                                @endif
    ...
    <div id="investmentModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <span style="font-weight: bold; font-style: 16px;">@lang('notifications.package.alert') <span class="package-name"></span></span>
