        ...
        <div class="container-fluid">
            <div class="header-body">
                ...
                <div class="plans-section">
                    ...
                    <div class="row">
                        @php /** @var $userMarketingPlanRegularActive \App\Models\Home\UserMarketingPlan */ @endphp
                        ...
                        <div class="col-12 plan plan-first justify-content-center active">
                            @php
                                $newRegular = $marketingPlanGroups['packages']['Regular'][0]
                            @endphp
                            <div class="row justify-content-center">
                                <div class="col-auto">
                                    <div class="card card-stats p-4">
                                        <div class="d-table ml-auto mr-auto pb-4 mb-2 mt-2">
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3" style="width: 70%">
                                                    <b>@lang('website_home.package.week_income', ['percent' => ''])</b>
                                                </div>
                                                <div class="d-table-cell py-1  pr-3" style="width: 30%">
                                                    <span id="plan-profit">
                                                             {{ $newRegular->min_profit }} - {{$newRegular->max_profit }}
                                                    </span>%
                                                </div>
                                            </div>
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3">
                                                    <b>@lang('website_home.package.period', ['days'=> ''])</b></div>
                                                <div
                                                    class="d-table-cell py-1 pr-3">@lang('website_home.package.period_days', ['days'=> 200])</div>
                                            </div>
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3">
                                                    <b>@lang('website_home.package.force_close')</b></div>
                                                <div
                                                    class="d-table-cell py-1 pr-3">@lang('website_home.package.yes')</div>
                                            </div>
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3">
                                                    <b>@lang('website_home.package.invest_body')</b></div>
                                                <div
                                                    class="d-table-cell py-1 pr-3">@lang('website_home.package.enable')</div>
                                            </div>
                                        </div>

                                        @foreach($marketingPlanGroups['packages']['Regular'] as $index => $marketingPlanGroup)
                                            @php
                                                $indexActive = $userMarketingPlanRegularActive && $userMarketingPlanRegularActive->marketing_plan_id === $marketingPlanGroup->id ? $index : 0;
                                            @endphp
                                            @if($indexActive != 0)
                                                @break
                                            @endif
                                        ...
                                        <div class="d-flex flex-row justify-content-center flex-wrap">
                                            @foreach($marketingPlanGroups['packages']['Regular'] as $index => $marketingPlanGroup)
                                                <div class="form_radio_btn">
                                                    <input id="radio-{{ $index + 1 }}" type="radio"
                                                           data-profit="{{ $marketingPlanGroup->daily_percent }}"
                                                           name="radio" value="{{ $index + 1 }}"
                                                           @if($index === $indexActive) checked @endif>
                                                    <label
                                                        for="radio-{{ $index + 1 }}">${{ $marketingPlanGroup->max_invest_sum }}</label>
                                                </div>
                                                @if($index === 2)
                                                    </div>
                                        ...
                                        @foreach($marketingPlanGroups['packages']['Regular'] as $index => $marketingPlanGroup)
                                            ...
                                            @if($userMarketingPlanRegularActive && $userMarketingPlanRegularActive->marketing_plan_id === $marketingPlanGroup->id)
                                                <button class="investment-btn btn btn-sm btn-primary {{ $btnClass }}"
                                                        disabled>
                                                    <strong>@lang('website_home.package.active_plan')</strong>
                                                </button>
                                            @else

                                                @if($userMarketingPlanRegularActive)
                                                    @if($userMarketingPlanRegularActive->marketingPlan->max_invest_sum > $marketingPlanGroup->min_invest_sum)
                                                        <button
                                                            class="investment-btn btn btn-sm btn-primary {{ $btnClass }}"
                                                            disabled>
                                                    ...
                                                    @else
                                                        <button
                                                            class="investment-btn btn btn-sm btn-primary {{ $btnClass }}"
                                                            data-upgrade="true"
                                                            data-amount="{{ $marketingPlanGroup->max_invest_sum - $userMarketingPlanRegularActive->marketingPlan->max_invest_sum }}"
                                                            data-id="{{ $marketingPlanGroup->id }}"
                                                            data-name=" $marketingPlanGroup->name SERVER 1"
                                                ...
                                                @else
                                                    <button
                                                        class="investment-btn btn btn-sm btn-primary {{ $btnClass }}"
                                                        data-amount="{{ $marketingPlanGroup->min_invest_sum }}"
                                                        data-id="{{ $marketingPlanGroup->id }}"
                        ...
                        <div class="col-12 plan plan-second justify-content-center">
                            @php
                                $newRandom = $marketingPlanGroups['packages']['Random'][0]
                            @endphp
                            <div class="row justify-content-center">
                                <div class="col-auto">
                                    <div class="card card-stats p-4 ">
                                        <div class="d-table ml-auto mr-auto pb-4 mb-2 mt-22">
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3" style="width: 70%">
                                                    <b>@lang('website_home.package.30_days_avg_income_percent', ['percent' => ''])</b>
                                                </div>
                                                <div class="d-table-cell py-1  pr-3" style="width: 30%">
                                                    <span id="plan-profit">
                                                             {{ $newRandom->min_profit * 20}} - {{$newRandom->max_profit * 20}}
                                                    </span>%
                                                </div>

{{--                                                <div class="d-table-cell py-1  pr-3"--}}
{{--                                                     style="width: 30%; white-space:nowrap">18 - 30%--}}
{{--                                                </div>--}}
                                            </div>
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3" style="width: 70%">
                                                ...
                                                <div class="d-table-cell py-1  pr-3"
                                                     style="width: 30%; white-space:nowrap">0.9 - 1.5%
                                                </div>
                                            </div>
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3">
                                            ...
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3">
                                                    <b>@lang('website_home.package.invest_body')</b></div>
                                                <div
                                                    class="d-table-cell py-1 pr-3">@lang('website_home.package.disable')</div>
                                            </div>
                                        </div>
                                        <div class="d-flex flex-row justify-content-center flex-wrap mb-3">
                                            @foreach($marketingPlanGroups['packages']['Random'] as $index => $marketingPlanGroup)
                                                <div class="form_radiocrypto_btn">
                                                    ...
                                                    >
                                                    <label
                                                        for="radio-{{ $marketingPlanGroup->id }}">{{ strtoupper($marketingPlanGroup->currency_type) }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                        <form class="js-crypto-form">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label"
                                                            ...
                                                            $</label>
                                                        <input class="form-control" type="number" name="amountInput"
                                                               min="500" max="100000" value="500" step="0.1"
                                                               oninput="this.form.amountRange.value=this.value"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label" for="input-currency"
                                                               id="label-currency">BTC</label>
                                                        <input id="input-currency" name="currency" type="number" min="0"
                                                               max="1000000" value="0" step="0.001" class="form-control"
                                                               type="text">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-row justify-content-center pb-4">
                                                ...
                                                <input class="flex-grow-1 range js-crypto-range" type="range"
                                                       name="amountRange" min="500" max="100000" value="500" step="0.1"
                                        ...
                                        <button
                                            class="investment-btn invest-crypto btn btn-sm btn-primary js-crypto-form-submit"
                                            data-type=""
                                            data-id=""
                                            data-name=""
                                            data-toggle="modal"
                                ...
                                <div class="col-auto">
                                    <div class="card card-stats p-4">
                                        <div class="d-table ml-auto mr-auto pb-4 mb-2 mt-2">
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3" style="width: 70%">
                                                    <b>@lang('website_home.package.daily_income', ['percent' => ''])</b>
                                                </div>
                                                <div class="d-table-cell py-1  pr-3" style="width: 30%"><span
                                                        id="plan-profit">0.95</span>%
                                                </div>
                                            </div>
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3">
                                            ...
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3">
                                                    <b>@lang('website_home.package.force_close')</b></div>
                                                <div
                                                    class="d-table-cell py-1 pr-3">@lang('website_home.package.no')</div>
                                            </div>
                                            <div class="d-table-row">
                                                <div class="d-table-cell pr-3 py-2 pl-3">
                                                    <b>@lang('website_home.package.invest_body')</b></div>
                                                ...
                                                @if($userMarketingPlanStandardActive)
                                                    ...
                                                    @else
                                                        <button
                                                            class="investment-btn btn btn-sm btn-primary {{ $btnClass }}"
                                                            data-upgrade="true"
                                                            data-amount="{{ $marketingPlanGroup->max_invest_sum - $userMarketingPlanStandardActive->marketingPlan->max_invest_sum }}"
                                                            data-id="{{ $marketingPlanGroup->id }}"
                                                            data-name=" $marketingPlanGroup->name SERVER 1"
                                                            data-toggle="modal" data-target="#investmentModal">
                                                            @lang('website_home.package.upgrade')
                        ...
                        {{-- Новый вид пакета Light временно убран --}}
                                    ...
                                    <div class="col-auto">
                                        <div class="card card-stats p-4">
                                            ...
                                            <div class="d-table ml-auto mr-auto pb-4 mt-2">
                                                <div class="d-table-row">
                                                    <div class="d-table-cell pr-3 py-2 pl-3" style="width: 70%"><b>@lang('website_home.package.week_income', ['percent' => ''])</b></div>
                                                    <div class="d-table-cell py-1  pr-3" style="width: 30%; white-space:nowrap">1.3 - 3.2%</div>
                                                </div>
                                                <div class="d-table-row">
                                                    <div class="d-table-cell pr-3 py-2 pl-3"><b>@lang('website_home.package.period', ['days'=> ''])</b></div>
                                                    <div class="d-table-cell py-1 pr-3">@lang('website_home.package.unlimited')</div>
                                    ...
                                    <div class="col-auto">
                                        <div class="card card-stats p-4">
                                            <small class="text-center"
                                                   style="margin-top:-0.7rem;">@lang('website_home.package.30_days_avg_income', ['from' => '20%', 'to' => '28%'])</small>
                                            <div class="d-table ml-auto mr-auto pb-4 mt-2">
                                                <div class="d-table-row">
                                                    <div class="d-table-cell pr-3 py-2 pl-3" style="width: 70%">
                                                        <b>@lang('website_home.package.week_income', ['percent' => ''])</b>
                                                    ...
                                                    <div class="d-table-cell py-1  pr-3"
                                                         style="width: 30%; white-space:nowrap">5 - 7%
                                                    </div>
                                                </div>
                                                <div class="d-table-row">
                                                    <div class="d-table-cell pr-3 py-2 pl-3">
                                                        <b>@lang('website_home.package.period', ['days'=> ''])</b></div>
                                                    <div
                                                        class="d-table-cell py-1 pr-3">@lang('website_home.package.period_days', ['days'=> '∞'])</div>
                                                </div>
                                                <div class="d-table-row">
                                                    <div class="d-table-cell pr-3 py-2 pl-3">
                                                        <b>@lang('website_home.package.force_close')</b></div>
                                            ...
                                            <form
                                                class="js-package js-package-{{ \App\Models\Home\MarketingPlan::GROUP_BUSINESS }}">
                                                <div class="row justify-content-center">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="form-control-label"
                                                ...
                                                <div class="d-flex flex-row justify-content-center pb-4">
                                                    <h4 class="mb-0 mr-2">
                                                        ${{ number_format($marketingPlanGroup->min_invest_sum, 0, '.', ' ') }}</h4>
                                                    <input class="flex-grow-1 range"
                                                           type="range"
                                                           name="amountRange"
                                                           min="{{ $marketingPlanGroup->min_invest_sum }}"
                        ...
                        {{-- Новый вид пакета Mini временно убран --}}
                        {{-- <div class="col-12 plan plan-four justify-content-center">
                            <div class="row justify-content-center">
                                @foreach($marketingPlanGroups['packages']['Mini'] as $marketingPlanGroup)
                                    <div class="col-auto">
                                        <div class="card card-stats p-4">
                                            <small class="text-center"
                                                   style="margin-top:-0.7rem;">@lang('website_home.package.30_days_avg_income_percent', ['percent' => '33%'])</small>
                                            <div class="d-table ml-auto mr-auto pb-4 mt-2">
                                                <div class="d-table-row">
                                                    <div class="d-table-cell pr-3 py-2 pl-3" style="width: 70%">
                                                        <b>@lang('website_home.package.daily_income', ['percent' => ''])</b>
                                                    ...
                                                    <div class="d-table-cell py-1  pr-3"
                                                         style="width: 30%; white-space:nowrap">0.5 - 2%
                                                    </div>
                                                </div>
                                                <div class="d-table-row">
                                                    <div class="d-table-cell pr-3 py-2 pl-3">
                                                        <b>@lang('website_home.package.period', ['days'=> ''])</b></div>
                                                    <div
                                                        class="d-table-cell py-1 pr-3">@lang('website_home.package.period_days', ['days'=> 220])</div>
                                                </div>
                                                <div class="d-table-row">
                                                    <div class="d-table-cell pr-3 py-2 pl-3">
                                                        <b>@lang('website_home.package.force_close')</b></div>
                                            ...
                                            <form
                                                class="js-package js-package-{{ \App\Models\Home\MarketingPlan::GROUP_MINI }}">
                                                <div class="row justify-content-center">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="form-control-label"
                                                                   for="input-amount">@lang('website_home.package.sum'),
                                                                $</label>
                                                            <input id="input-amount-range-2" class="form-control"
                                                                   type="number" name="amountInput"
                                                                   min="{{ $marketingPlanGroup->min_invest_sum }}"
                                                                   max="{{ $marketingPlanGroup->max_invest_sum }}"
                                                                   value="{{ $marketingPlanGroup->min_invest_sum }}"
                                                                   step="1"
                                                ...
                                                <div class="d-flex flex-row justify-content-center pb-4">
                                                    ...
                                                    <input class="flex-grow-1 range" type="range" name="amountRange"
                                                           min="{{ $marketingPlanGroup->min_invest_sum }}"
                                                           max="{{ $marketingPlanGroup->max_invest_sum }}"
                                                           value="{{ $marketingPlanGroup->min_invest_sum }}" step="10"
                                                           oninput="this.form.amountInput.value=this.value"/>
                                                    <h4 class="mb-0 ml-2">$10 000</h4>
                                                </div>
                                            </form>
    ...
    <div class="container-fluid">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(isset($item->marketingPlan->name))
                                            @if(strpos($item->marketingPlan->name,'Standard') !== false)
                                                SERVER 1
                                            @endif
                                            @if(strpos($item->marketingPlan->name,'Business') !== false)
                                                SERVER 2
                                            @endif
                                    ...
                                    <td>
                                        @if(!$item->end_at && !$item->marketingPlan->isUnlimitedDuration())
                                            @lang('website_home.package.end_date'):
                                            <br>{{\Carbon\Carbon::now()->addDays($item->days_left)->format('d.m.Y')}}
                                            <br>
                                        @endif
                                        @if($item->id)
                                            ...
                                            @if(!$item->isStopped() && $item->marketingPlan->available_for_withdrawal == 1 && is_null($item->end_at) && $item->days_left > 30)
                                                @if (
                                                    ...
                                                    <a href="{{ route('home.marketing-plans.invest.withdraw', ['id' => $item->id]) }}"
                                                       class="invest-withdraw">@lang('website_home.package.package_withdraw')</a>
                                                    <br>
                                                @endif
                                                <a href="javascript:;" class="close-investment-btn"
                                                   data-withdrawal_commission="{{$item->marketingPlan->withdrawal_commission}}"
                                                   data-id="{{$item->id}}">{{__('base.dash.investments.close')}}</a>
                                            @endif
                                        @endif
                                    </td>
                                </tr>
        ...
        <div id="closeInvestment" class="modal fade" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>@lang('base.dash.investments.confirm.commission') <b id="label-withdrawal_commission">8%</b>
                        </p>
                        <form id="close-investment-form" action="{{route('home.marketing-plans.close.with.commision')}}"
                              method="POST">
                            @csrf
                            <input type="hidden" name="marketing_plan_id" id="marketing-plan-id">
                        </form>
                        <button class="btn btn-danger js-decline-close-investment"
                                data-dismiss="modal">@lang('base.dash.investments.confirm.no')</button>
                        <button class="btn btn-success"
                                form="close-investment-form">@lang('base.dash.investments.confirm.close')</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="investmentModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <span style="font-weight: bold; font-size: 16px;">@lang('notifications.package.alert') <span
                    ...
                    <div class="modal-body">
                        <form id="invest-usd-form" action="{{route('home.marketing-plans.invest')}}" method="POST">
                            @csrf
                            <div style="display: none;" id="modal-upgrade-text">
                                <strong>@lang('website_home.package.upgrade_description')</strong></div>
                            <label id="label-usd">$<span id="label-usd-value">0</span></label>
                            <input for="label-usd" type="range" step="10" min="0" class="form-control"
                                   placeholder="@lang('base.dash.investments.package.amount_ph')" name="invest_usd">
                            <input type="hidden" name="marketing_plan_id" class="marketing_plan_id">
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-default invest-btn"
                                data-form="invest-usd-form">@lang('base.dash.investments.package.button')</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="investmentModalCrypto" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="invest-crypto-form" action="{{route('home.marketing-plans.invest.crypto')}}"
                              method="POST">
                            @csrf
                            <label><span id="modal-crypto-amount">0</span> <span
                                    id="modal-crypto-currency"></span></label>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-default invest-btn"
                                data-form="invest-crypto-form">@lang('base.dash.investments.package.button')</button>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default"
                                data-dismiss="modal">@lang('notifications.package.cancel')</button>
